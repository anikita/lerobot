...
| [dataset-viz-generic-scalars](https://github.com/huggingface/lerobot/issues/3880) | Feature request: render all scalar columns generically | 2026-06-26 | enhancement | `dataset-viz-generic-scalars` |
| [#3883](https://github.com/huggingface/lerobot/issues/3883) | lerobot-edit-dataset merge: video chunk boundaries don't match actual video file lengths | 2026-06-27 | bug, dataset | `fix-video-chunk-boundary` |
